...
#import "HTDispatchProxy.h"
#import <objc/runtime.h>
@interface HTDispatchProxy ()
@property (nonatomic, strong) Protocol * protocol;
@property (nonatomic, strong) NSOrderedSet * objects;
@end

@implementation HTDispatchProxy

+ (instancetype)dispatchForProtocol:(Protocol*)protocol withObjects:(NSArray*)objects
{
    HTDispatchProxy * multiproxier = [[super alloc] initWithProtocol:protocol objects:objects];
    return multiproxier;
}
